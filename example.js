...
Deno.serve(async req => {
  ...
  const paymentIntent = await stripe.paymentIntents.create({
    //this this with 1 post request and look at it at the end of this file
    //amount: 7000, // $70.00 and choose any amount you want

    //this this with 2 post request and look at it at the end of this file
    amount: totalAmount,
    currency: 'usd',
